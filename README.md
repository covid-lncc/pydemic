...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.3865005.svg)](https://doi.org/10.5281/zenodo.3865005)
...
## How to reproduce the results from your paper?

Please have a look at `PAPER.md` file provided in the root of this repository.

## How can I set my environment to develop `pydemic`?

In the file `DEVELOPING.md`, we provide brief instructions and guidelines that we adopt. Please feel free to look inside it.
