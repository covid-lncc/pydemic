...
plt.text(0.913 * C_last_low_percentile, 605, f'{C_last_low_percentile:.0f}', fontsize=15, color=DCOLOR)
plt.text(1.005 * C_last_high_percentile, 605, f'{C_last_high_percentile:.0f}', fontsize=15, color=DCOLOR)
...
plt.text(0.970 * D_last_low_percentile, 505, f'{D_last_low_percentile:.0f}', fontsize=15, color=DCOLOR)
plt.text(1.003 * D_last_high_percentile, 505, f'{D_last_high_percentile:.0f}', fontsize=15, color=DCOLOR)
...
plt.text(0.975 * confirmed_cases_today, 605, f'{confirmed_cases_today:.0f}', fontsize=15, color=DCOLOR)
...
plt.text(0.987 * deaths_today, 505, f'{deaths_today:.0f}', fontsize=15, color=DCOLOR)
...
ax2.yaxis.set_major_locator(MultipleLocator(200000))
